...
DB_ID = "f11c954da24143acb6e2bf0254b64079"
PROPERTY_FILTER = [r"%7CVjk", r"Ye%40l", r"Mgz%3F", r"KQKT", r"zUY%3F", r"%3AL%5EW", r"a%3Ceu", r"nNsG"]
CONTENT_FILTER = {
    "and": [
        {
            "property": "Job status",
...
notion_response = notion_helper.query("f11c954da24143acb6e2bf0254b64079", PROPERTY_FILTER, CONTENT_FILTER)
